    ...
    <div class="container">
        <div class="col-sm-10 col-sm-offset-1">
            ...
            <div class="col-sm-4">
                <div class="cardCn c1">
                    <div class="cardCnH">
                        <div class="cH">Щитовые конструкции</div>
                        <div class="cB">Мы производим печать бордов в короткое время с высоким качеством</div>
                    </div>
                    <div class="cardCnB">
                        <div class="col-sm-6 imgFlt">
                            <img class="cntImg" src="{{asset('/img/cardImg01.png')}}"/>
                        </div>
                        <div class="col-sm-6 btnFlt">
                            <button class="ccG">Галерея</button>
                            <button class="ccM">Подробнее...</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="cardCn c2">
                    <div class="cardCnH">
                        <div class="cH">Брандмауэры и лайтпостеры</div>
                        <div class="cB">Мы проводим печать бордов в короткое время с высоким качеством</div>
                    </div>
                    <div class="cardCnB">
                        <div class="col-sm-6 imgFlt">
                            <img class="cntImg" src="{{asset('/img/cardImg02.png')}}"/>
                        </div>
                        <div class="col-sm-6 btnFlt">
                            <button class="ccG">Галерея</button>
                            <button class="ccM">Подробнее...</button>
            ...
            <div class="col-sm-4">
                <div class="cardCn c3">
                    <div class="cardCnH">
                        <div class="cH">UV-Печать</div>
                        <div class="cB">Печать на различных материалах (дерево, стекло, пластик и т.д.)</div>
                    </div>
                    <div class="cardCnB">
                        <div class="col-sm-6 imgFlt">
                            <img class="cntImg" src="{{asset('/img/cardImg03.png')}}"/>
                        </div>
                        <div class="col-sm-6 btnFlt">
                            <button class="ccG">Галерея</button>
                            <button class="ccM">Подробнее...</button>
            ...
            <div class="col-sm-4">
                <div class="cardCn c4">
                    <div class="cardCnH">
                        <div class="cH">Печать для призматронов</div>
                        <div class="cB">Мы производим печать бордов в короткое время с высоким качеством</div>
                    </div>
                    <div class="cardCnB">
                        <div class="col-sm-6 imgFlt">
                            <img class="cntImg" src="{{asset('/img/cardImg04.png')}}"/>
                        </div>
                        <div class="col-sm-6 btnFlt">
                            <button class="ccG">Галерея</button>
                            <button class="ccM">Подробнее...</button>
            ...
            <div class="col-sm-4">
                <div class="cardCn c5">
                    <div class="cardCnH">
                        <div class="cH">Интерьерная печать</div>
                        <div class="cB">Мы производим печать бордов в короткое время с высоким качеством</div>
                    </div>
                    <div class="cardCnB">
                        <div class="col-sm-6 imgFlt">
                            <img class="cntImg" src="{{asset('/img/cardImg05.png')}}"/>
                        </div>
                        <div class="col-sm-6 btnFlt">
                            <button class="ccG">Галерея</button>
                            <button class="ccM">Подробнее...</button>
            ...
            <div class="col-sm-4">
                <div class="cardCn c6">
                    <div class="cardCnH">
                        <div class="cH">Все виды бренд оформления</div>
                        <div class="cB">Персональное брендирование, оформление мероприятий</div>
                    </div>
                    <div class="cardCnB">
                        <div class="col-sm-6 imgFlt">
                            <img class="cntImg" src="{{asset('/img/cardImg06.png')}}"/>
                        </div>
                        <div class="col-sm-6 btnFlt">
                            <button class="ccG">Галерея</button>
                            <button class="ccM">Подробнее...</button>
            ...
            <div class="col-sm-6 mb16" style="padding: 0 8px">
                <div class="col-sm-12 cardNews">
                    <div class="col-sm-12 mb16 taC">
                        <div class="col-sm-12">новости печати</div>
                        <div class="col-sm-12">
                            <h3 class="h3">Колейдоскоп Технологии</h3>
                        </div>
                        <div class="col-sm-12 dateTxt">Опубликовано 12 декабря 2017</div>
                    </div>
                    <img class="col-sm-12 mb16 w100" src="{{asset('/img/cntnOld.png')}}"/>
                    <div class="col-sm-12 mb16">Многие заказчики полагают, что особой разницы между печатный продукцией разных типографий нет. В действительности даже небольшой тираж печатной продукции всегда эксклюзивен. Поэтому при размещении одинаковых заказов трех разных пографиях...</div>
                    <div class="col-sm-12 p0 flex-space-between">
                        <div class="col-sm-6">
                            <a href="/news/new" class="link btn toNewsBtn">Перейти к новости</a>
                        </div>
            ...
            <div class="col-sm-6 mb16" style="padding: 0 8px">
                <div class="col-sm-12 cardNews">
                    <div class="col-sm-12 mb16 taC">
                        <div class="col-sm-12">новости печати</div>
                        <div class="col-sm-12">
                            <h3 class="h3">Маленькие секреты полиграфического бизнеса</h3>
                        </div>
                        <div class="col-sm-12 dateTxt">Опубликовано 12 декабря 2017</div>
                    </div>
                    <img class="col-sm-12 mb16 w100" src="{{asset('/img/cntnNew.png')}}"/>
                    <div class="col-sm-12 mb16">Многие заказчики полагают, что особой разницы между печатный продукцией разных типографий нет. В действительности даже небольшой тираж печатной продукции всегда эксклюзивен. Поэтому при размещении одинаковых заказов трех разных пографиях...</div>
                    <div class="col-sm-12 p0 flex-space-between">
                        <div class="col-sm-6">
                            <button class="btn toNewsBtn">Перейти к новости</button>
                        </div>
                        <div class="col-sm-6 taR R">
                            <div class="btn-social vk">
                                <svg width="20" height="24" viewBox="0 0 26 26" fill="#979797">
                            ...
                            <div class="btn-social vk">
                                <svg width="20" height="24" viewBox="0 0 26 26" fill="#979797">
                                    <path xmlns="http://www.w3.org/2000/svg" d="M17,2V2H17V6H15C14.31,6 14,6.81 14,7.5V10H14L17,10V14H14V22H10V14H7V10H10V6A4,4 0 0,1 14,2H17Z"/>
                                </svg>
                            </div>
                            <div class="btn-social vk">
                                <svg width="20" height="24" viewBox="0 0 26 26" fill="#979797">
